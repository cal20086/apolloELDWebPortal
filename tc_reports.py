    ...
    if control_Reportfile == 0:
        ...
        if control_Reportfile == 1:
            if assert_Condition == 0:
                ...
                testCaseCounter_Global = testCaseCounter_Global + 1
                #print(f'TestCaseCounter_Global = {testCaseCounter_Global}')
...
def summaryPerformance_by_Driver(driver, driver_Name, datebyDriver):
    ...
    print('=========================================================================\n', file=TCReport)
    print(f'Driver: {driver_Name} \n', file=TCReport)
    print(f' *** Test SUMMARY Performance ***:  Test Cases Ran => {testCaseCounter_Global}\n', file=TCReport)
    print(f' *** Test SUMMARY Performance ***:  Test Execution Time => {datebyDriver}\n', file=TCReport)
    print('=========================================================================\n', file=TCReport)
    print('', file=TCReport)
    TCReport.close()
...
def screenshot (driver, driver_Name, test_Name):
    ...
    screenshot_name_full = driver_Name[0:3] + "_" + screenshot_name
    screenshot_name_full = screenshot_name_full[0:19]
    screenshot_name = reportFolder_Path_QAReports + screenshot_name_full + filetype
