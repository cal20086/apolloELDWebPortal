...
#   Work Order Status:
    ...
    print(f"input_Status_WorkOrder_WorkOrderPage = {input_Status_WorkOrder_WorkOrderPage}")

#   Work Order Number check on Work Order Details
    ...
    buttoneye_workOrderNumber_InTest_WorkOrder_ManageWorkOrderAdr_End = "]/td[5]/div/div[1]/button"
...
#   Verify the Work Order Information with the information from Assign Work Order got form def test_AssignWorkOrder_Vendor.assignWorkOrder_Vendor
