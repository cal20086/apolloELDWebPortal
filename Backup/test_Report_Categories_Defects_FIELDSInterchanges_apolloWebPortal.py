...
#   Address
    ...
    colum_DefectByReportType = "S"
    colum_reportConditionsTestQte = "T"
    colum_ReportbyCategorieType = "U"
    colum_CategoryType = "V"
    colum_DefectByCategoryType = "W"
    colum_CategoryDefectTestQte = "X"
...
#                   MAIN                **********************************
    ...
    try:
        ...
        #   Read Categorie after selecting Report and compare with Excel expected value
            ...
            print_Information_Var = report_Read + " / " + category_Read + " / " + input_Defects_Page_Read + " => Categorie options = " + str(len(dropBox_Categories_MoreFilter_List))
            test_Case_Type = ""
            contol_Reportfile = 1
            tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
            x = x + 1
        ...
        print("ERROR - Report, Categories and Defects Logic test")
    ...
    try:
        ...
        while n <= categoriesConditionsTestQte:
            ...
            # Read Report
            report_Type_excel = (str(colum_ReportbyCategorieType) + str(x))
            report_excel = worksheetDB_Read[report_Type_excel].value
            report_Read = dropBox_Report_Page.first_selected_option.text
            print(report_Read)
            # Assert
            ...
            input_Defects_Page_Read = input_Defects_Page_Read.replace('\n', "")
            input_Defects_Page_Read = input_Defects_Page_Read.replace(" ", "")
            print(f'defect ={input_Defects_Page_Read}')
            # Assert
            test_Name = "Categories auto-selected - Logic Interrelated "
            condition1 = str(defect_excel)
            condition2 = str(input_Defects_Page_Read)
            ...
            print_Information_Var = category_Read + " / " + report_Read + " / " + input_Defects_Page_Read
            test_Case_Type = ""
            contol_Reportfile = 1
            tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
        ...
        print("ERROR - Categories det -> Report and Defect auto set")
    #       Screenshot
